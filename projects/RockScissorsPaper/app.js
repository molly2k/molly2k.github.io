const playerPointsSpan = document.querySelector(".player__points");
const compPointsSpan = document.querySelector(".comp__points");
const optionsButtons = document.querySelectorAll(".options button");
const choicesSection = document.querySelector(".choices");
const playerChoiceSpan = document.querySelector(".player__choice");
const compChoiceSpan = document.querySelector(".computer__choice");
const resultText = document.querySelector(".result__text");
const resetGameButton = document.querySelector(".reset__game");
